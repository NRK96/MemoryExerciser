...
public class MemoryExerciser {
	...
	int[] numbers = new int[size]; // the list of integeres
	...
	// get the user's answer, report how many are correct
    ...
    // gets the user's answers and returns the number correct against the list
